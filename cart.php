...
<body class="ps-loading">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="deleteCart.php?userId=<?php echo $infoUser['id'] ?>&shoeId=<?php echo $shoe['shoe_id'] ?>">
  ...
  <script>
    function eventMinus(event, i) {
  event.preventDefault(); // Ngăn chặn hành vi mặc định của nút
  var price = parseFloat(document.getElementById("price" + i).innerText);
  var quantity = document.getElementById("quantity" + i);
  if (parseInt(quantity.value) > 1) {
    quantity.value = parseInt(quantity.value) - 1;
    document.getElementById("total" + i).innerText = parseFloat(price) * parseInt(quantity.value);
    totalPrice();
  }
}

function plusMinus(event, i) {
  event.preventDefault(); // Ngăn chặn hành vi mặc định của nút
  var price = parseFloat(document.getElementById("price" + i).innerText);
  var quantity = document.getElementById("quantity" + i);
